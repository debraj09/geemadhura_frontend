        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              className="relative"
            >
              <div className="relative h-[500px] bg-gradient-to-br from-[#00283A]/10 to-[#F2C445]/10 rounded-3xl overflow-hidden shadow-2xl border-2 border-[#00283A]/20 hover:border-[#F2C445] transition-all duration-300">
                {/* Decorative elements */}
                <div className="absolute top-0 left-0 w-32 h-32 bg-[#00283A]/5 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
                <div className="absolute bottom-0 right-0 w-48 h-48 bg-[#F2C445]/5 rounded-full translate-x-1/3 translate-y-1/3"></div>
              </div>
              {/* Floating badge */}
              <motion.div
                initial={{ scale: 0 }}
                ...
                className="absolute -bottom-6 -right-6 bg-[#F2C445] text-[#00283A] px-8 py-4 rounded-2xl shadow-xl border-2 border-[#F2C445] hover:border-[#00283A] transition-all duration-300"
              >
              ...
              >
                ...
                <div className={`relative ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  <div className="relative group">
                    {/* Main image */}
                    <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl border-2 border-[#00283A]/20 group-hover:border-[#F2C445] transition-all duration-300">
                      <img 
                        src={director.image} 
                        alt={director.name}
